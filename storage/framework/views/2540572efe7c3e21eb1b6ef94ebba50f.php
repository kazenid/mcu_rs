...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mt-4 text-center">
                                        <div class="signin-other-title">
                                            <h5 class="fs-13 mb-4 title">Menu Lain</h5>
                                        </div>
                                        <div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> RSUD Bangil. Dibuat dengan <i class="mdi mdi-heart text-danger"></i> oleh Instalasi SIMRS</p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\mcu_rs\resources\views/auth/login.blade.php ENDPATH**/ ?>